    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            # for input, label in dataset_loader:
                ...
                # inputs, labels = input.to('cuda'), label.to('cuda')
...
def myeval(model, dataset_loader, criterion, optimizer):
...
if __name__ == "__main__":
    ...
    # model = torch.load(r'model_weights/classifier1_weights.pth')
    # print(model)
    ...
    train_loader = DataLoader(train_dataset, batch_size=4, shuffle=False, num_workers=4, pin_memory=torch.cuda.is_available())
    ...
    # myeval(model, val_loader, criterion, optimizer)
    # Save the model
